...
public class PaperSetting {
    ...
    protected static final int LETTER_HEIGHT = 11 * 72;

    protected static final int LEGAL_WIDTH = (int)(8.5 * 72);
    protected static final int LEGAL_HEIGHT = 14 * 72;
    ...
    public static Paper getDevelop9()
    {
    ...
    public static Paper getDevelop10()
    {
    ...
    public static Paper getDevelopC5()
    {
    ...
    public static Paper getDevelopMonarch()
    {
    ...
    public static Paper getDevelopDl()
    {
    ...
    public static Paper getDevelopB5()
    {
    ...
    public static int getIndex(double width, double height)
    {
